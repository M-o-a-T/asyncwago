...
htmlhelp_basename = 'asyncwago-doc'
...
latex_documents = [
    (master_doc, 'asyncwago.tex', 'Trio Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'asyncwago', 'AsyncWago Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'asyncwago', 'AsyncWago Documentation',
     author, 'AsyncWago', 'Access I/O on Wago controllers',
     'Miscellaneous'),
]
