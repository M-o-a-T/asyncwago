...
latex_documents = [
    (master_doc, 'wago.tex', 'Trio Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'wago', 'Wago Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'wago', 'Wago Documentation',
     author, 'Wago', 'Access I/O on Wago controllers',
     'Miscellaneous'),
]
